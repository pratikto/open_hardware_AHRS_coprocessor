...
set C_modelName {normalise}
set C_modelType { void 0 }
set C_modelArgList {
	{ in_r float 32 regular {array 4 { 2 3 } 1 1 }  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.MadgwickAHRSupdatcud_U2", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.MadgwickAHRSupdatdEe_U3", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	in_r { ap_memory {  { in_r_address0 mem_address 1 2 }  { in_r_ce0 mem_ce 1 1 }  { in_r_we0 mem_we 1 1 }  { in_r_d0 mem_din 1 32 }  { in_r_q0 mem_dout 0 32 } } }
}
