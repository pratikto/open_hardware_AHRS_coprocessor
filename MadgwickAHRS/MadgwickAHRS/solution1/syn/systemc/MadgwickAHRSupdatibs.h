...
#ifndef __MadgwickAHRSupdatibs__HH__
#define __MadgwickAHRSupdatibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(MadgwickAHRSupdatibs) {
    ...
    SC_CTOR(MadgwickAHRSupdatibs):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {
