...
#ifndef __MadgwickAHRSupdatbkb__HH__
#define __MadgwickAHRSupdatbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(MadgwickAHRSupdatbkb) {
    ...
    SC_CTOR(MadgwickAHRSupdatbkb):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
