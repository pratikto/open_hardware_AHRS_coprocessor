...
#ifndef __MadgwickAHRSupdatdEe__HH__
#define __MadgwickAHRSupdatdEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(MadgwickAHRSupdatdEe) {
    ...
    SC_CTOR(MadgwickAHRSupdatdEe):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
