...
//		normType4(a);
//
//		// Auxiliary variables to avoid repeated arithmeticq
//
//		_2q0 = 2.0f * Q[0];
//		_2q1 = 2.0f * Q[1];
//		_2q2 = 2.0f * Q[2];
...
//		_2q2q3 = 2.0f * Q2Q3;
//
//		f1[0] = _2q1q3 - _2q0q2 - a[0];
//		f1[1] = _2q0q1 + _2q2q3 - a[1];
//		f1[2] = 1 - 2.0f * Q1Q1 - 2.0f * Q2Q2 - a[2];
//
//		j1[0][0] = -_2q2;
//		j1[0][1] = _2q1;
//		j1[0][2] = 0.0f;
...
//			_4bz = 4.0f * h[3];
//
//			f2[0] = _2bx * (0.5f - Q2Q2 - Q3Q3) + h[3] * (_2q1q3 - _2q0q2)    			- m[0];
//			f2[1] = _2bx * (Q1Q2 - Q0Q3)        + h[3] * (_2q0q1 + _2q2q3) 				- m[1];
//			f2[2] = _2bx * (Q0Q2 + Q1Q3)        + h[3] * (1.0f - 2 * Q1Q1 - 2 * Q2Q2) 	- m[2];
//
//			j2[0][0] = - h[3] * _2q2;
//			j2[0][1] = -_2bx * Q[3] + h[3] * _2q1;
//			j2[0][2] = _2bx * Q[2];
//
//			j2[1][0] = h[3] * _2q3;
//			j2[1][1] = _2bx * Q[2] + h[3] * _2q0;
//			j2[1][2] = _2bx * Q[3] - _4bz * Q[1];
//
//			j2[2][0] = -_4bx * Q[2] - h[3] * _2q0;
//			j2[2][1] = _2bx * Q[1] + h[3] * _2q3;
//			j2[2][2] = _2bx * Q[0] - _4bz * Q[2];
//
//			j2[3][0] = -_4bx * Q[3] + h[3] * _2q1;
//			j2[3][1] = -_2bx * Q[0] + h[3] * _2q2;
//			j2[3][2] = _2bx * Q[1];
//
//			// Gradient decent algorithm corrective step
//			mul2matrix(s2, j2, f2);
...
//
//		// Gradient decent algorithm corrective step
//		s1[0] = temp1[0] * Q2Q2 + _2q2 * a[0] + temp1[0] * Q1Q1 - _2q1 * a[1];
//		s1[1] = temp1[1] * Q3Q3 - _2q3 * a[0] + 4.0f * Q0Q0 * Q[1] - _2q0 * a[1] - temp1[1] + temp1[3] * Q1Q1 + temp1[3] * Q2Q2 + temp1[1] * a[2];
//		s1[2] = 4.0f * Q0Q0 * Q[2] + _2q0 * a[0] + temp1[2] * Q3Q3 - _2q3 * a[1] - temp1[2] + _8q2 * Q1Q1 + _8q2 * Q2Q2 + temp1[2] * a[2];
//		s1[3] = 4.0f * Q1Q1 * Q[3] - _2q1 * a[0] + 4.0f * Q2Q2 * Q[3] - _2q2 * a[1];
//
////		s1[0] = _4q0 * Q2Q2 + _2q2 * a[0] + _4q0 * Q1Q1 - _2q1 * a[1];
////		s1[1] = _4q1 * Q3Q3 - _2q3 * a[0] + 4.0f * Q0Q0 * Q[1] - _2q0 * a[1] - _4q1 + _8q1 * Q1Q1 + _8q1 * Q2Q2 + _4q1 * a[2];
////		s1[2] = 4.0f * Q0Q0 * Q[2] + _2q0 * a[0] + _4q2 * Q3Q3 - _2q3 * a[1] - _4q2 + _8q2 * Q1Q1 + _8q2 * Q2Q2 + _4q2 * a[2];
////		s1[3] = 4.0f * Q1Q1 * Q[3] - _2q1 * a[0] + 4.0f * Q2Q2 * Q[3] - _2q2 * a[1];
//
//		// MARG algorithm
//		if((m[0] != 0.0f) && (m[1] != 0.0f) && (m[2] != 0.0f)) {
...
//			_4bz = 2.0f * _2bz;
//
//			temp1[0] = (_2bx * (0.5f - Q2Q2 - Q3Q3) + _2bz * (Q1Q3 - Q0Q2) - m[0]);
//			temp1[1] = (_2bx * (Q1Q2 - Q0Q3) + _2bz * (Q0Q1 + Q2Q3) - m[1]);
//			temp1[2] = (_2bx * (Q0Q2 + Q1Q3) + _2bz * (0.5f - Q1Q1 - Q2Q2) - m[2]);
//
//			// Gradient decent algorithm corrective step
//			s2[0] = - _2bz * Q[2] * temp1[0] 				+ (-_2bx * Q[3] + _2bz * Q[1]) * temp1[1] 	+ _2bx * Q[2] * temp1[2];
//			s2[1] = _2bz * Q[3] * temp1[0] 					+ (_2bx * Q[2] + _2bz * Q[0]) * temp1[1] 	+ (_2bx * Q[3] - _4bz * Q[1]) * temp1[2];
//			s2[2] = (-_4bx * Q[2] - _2bz * Q[0]) * temp1[0] + (_2bx * Q[1] + _2bz * Q[3]) * temp1[1] 	+ (_2bx * Q[0] - _4bz * Q[2]) * temp1[2];
//			s2[3] = (-_4bx * Q[3] + _2bz * Q[1]) * temp1[0] + (-_2bx * Q[0] + _2bz * Q[2]) * temp1[1] 	+ _2bx * Q[1] * temp1[2];
//
//			add2vector(s1, s2);
//		}
//
