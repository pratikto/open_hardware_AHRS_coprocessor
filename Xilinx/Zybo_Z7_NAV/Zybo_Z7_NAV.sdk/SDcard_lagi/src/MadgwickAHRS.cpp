...
//	euler[2] = hls::atan2f(q1q2 + q0q3, 0.5f - q2q2 - q3q3);
	euler[0] = atan2f(q0q1 + q2q3, 0.5f - q1q1 - q2q2);
	euler[1] = asinf(-2.0f * (q1q3 - q0q2));
	euler[2] = atan2f(q1q2 + q0q3, 0.5f - q2q2 - q3q3);
...
//		recipNorm = rsqrtf(input[1] * input[1] + input[2] * input[2] + input[3] * input[3]);
		recipNorm = 1 / sqrtf(input[1] * input[1] + input[2] * input[2] + input[3] * input[3]);
	}
	else{
...
//		recipNorm = hls::rsqrtf(input[0] * input[0] + input[1] * input[1] + input[2] * input[2] + input[3] * input[3]);
		recipNorm = sqrtf(powf(input[0], 2) +powf(input[1], 2) + powf(input[2], 2) + powf(input[3], 2));
//		recipNorm = rsqrtf(input[0] * input[0] + input[1] * input[1] + input[2] * input[2] + input[3] * input[3]);
		recipNorm = 1 / sqrtf(input[0] * input[0] + input[1] * input[1] + input[2] * input[2] + input[3] * input[3]);
		input[0] *= recipNorm;
...
void normType4(float input[3]){
	float recipNorm;
//	recipNorm = rsqrtf(input[0] * input[0] + input[1] * input[1] + input[2] * input[2]);
	recipNorm = 1/ sqrtf(input[0] * input[0] + input[1] * input[1] + input[2] * input[2]);
