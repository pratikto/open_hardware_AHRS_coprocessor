...
define internal fastcc void @integrateQdot([4 x float]* nocapture %q, float %p_read, float %p_read1, float %p_read2, float %p_read3) {
  %p_read_1 = call float @_ssdm_op_Read.ap_auto.float(float %p_read3)
  %p_read_2 = call float @_ssdm_op_Read.ap_auto.float(float %p_read2)
  %p_read_3 = call float @_ssdm_op_Read.ap_auto.float(float %p_read1)
  %p_read_4 = call float @_ssdm_op_Read.ap_auto.float(float %p_read)
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str2) nounwind
  %tmp_s = fmul float %p_read_4, 1.953125e-03
  %q_addr = getelementptr [4 x float]* %q, i64 0, i64 0
  %q_load = load float* %q_addr, align 4
  %tmp_8 = fadd float %q_load, %tmp_s
  store float %tmp_8, float* %q_addr, align 4
  %tmp_1 = fmul float %p_read_3, 1.953125e-03
  %q_addr_1 = getelementptr [4 x float]* %q, i64 0, i64 1
  %q_load_1 = load float* %q_addr_1, align 4
  %tmp_8_1 = fadd float %q_load_1, %tmp_1
  store float %tmp_8_1, float* %q_addr_1, align 4
  %tmp_2 = fmul float %p_read_2, 1.953125e-03
  %q_addr_2 = getelementptr [4 x float]* %q, i64 0, i64 2
  %q_load_2 = load float* %q_addr_2, align 4
  %tmp_8_2 = fadd float %q_load_2, %tmp_2
  store float %tmp_8_2, float* %q_addr_2, align 4
  %tmp_3 = fmul float %p_read_1, 1.953125e-03
  %q_addr_3 = getelementptr [4 x float]* %q, i64 0, i64 3
  %q_load_3 = load float* %q_addr_3, align 4
  %tmp_8_3 = fadd float %q_load_3, %tmp_3
  store float %tmp_8_3, float* %q_addr_3, align 4
  ret void
}
...
define internal fastcc { float, float, float, float } @feedbackStep(float %qDot_0_read, float %qDot_1_read, float %qDot_2_read, float %qDot_3_read, float %beta, float %s_0_read, float %s_1_read, float %s_2_read, float %s_3_read) readnone {
  %s_3_read_1 = call float @_ssdm_op_Read.ap_auto.float(float %s_3_read)
  %s_2_read_1 = call float @_ssdm_op_Read.ap_auto.float(float %s_2_read)
  %s_1_read_1 = call float @_ssdm_op_Read.ap_auto.float(float %s_1_read)
  %s_0_read_1 = call float @_ssdm_op_Read.ap_auto.float(float %s_0_read)
  %beta_read = call float @_ssdm_op_Read.ap_auto.float(float %beta)
  %qDot_3_read_1 = call float @_ssdm_op_Read.ap_auto.float(float %qDot_3_read)
  %qDot_2_read_1 = call float @_ssdm_op_Read.ap_auto.float(float %qDot_2_read)
  %qDot_1_read_1 = call float @_ssdm_op_Read.ap_auto.float(float %qDot_1_read)
  %qDot_0_read_1 = call float @_ssdm_op_Read.ap_auto.float(float %qDot_0_read)
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str2) nounwind
  %tmp_s = fmul float %s_0_read_1, %beta_read
  %qDot = fsub float %qDot_0_read_1, %tmp_s
  %tmp_1 = fmul float %s_1_read_1, %beta_read
  %qDot_1 = fsub float %qDot_1_read_1, %tmp_1
  %tmp_2 = fmul float %s_2_read_1, %beta_read
  %qDot_2 = fsub float %qDot_2_read_1, %tmp_2
  %tmp_3 = fmul float %s_3_read_1, %beta_read
  %qDot_3 = fsub float %qDot_3_read_1, %tmp_3
  %mrv = insertvalue { float, float, float, float } undef, float %qDot, 0
  %mrv_1 = insertvalue { float, float, float, float } %mrv, float %qDot_1, 1
  %mrv_2 = insertvalue { float, float, float, float } %mrv_1, float %qDot_2, 2
  %mrv_3 = insertvalue { float, float, float, float } %mrv_2, float %qDot_3, 3
  ret { float, float, float, float } %mrv_3
}
...
; <label>:1                                       ; preds = %0
  ...
  %notlhs3 = icmp ne i8 %tmp_66, -1
  %notrhs4 = icmp eq i23 %tmp_67, 0
  %tmp_68 = or i1 %notrhs4, %notlhs3
...
; <label>:2                                       ; preds = %1
  ...
  %notlhs5 = icmp ne i8 %tmp_71, -1
  %notrhs6 = icmp eq i23 %tmp_72, 0
  %tmp_73 = or i1 %notrhs6, %notlhs5
...
._crit_edge:                                      ; preds = %2, %1, %0
  ...
  %call_ret1 = call fastcc { float, float, float } @normalise.1(float %s_0, float %s_1, float %s_2, float %s_3)
  %s_2_1 = extractvalue { float, float, float } %call_ret1, 1
  %s_1_1 = extractvalue { float, float, float } %call_ret1, 0
  %s_0_1 = extractvalue { float, float, float } %call_ret1, 2
  %beta_load = load float* @beta, align 4
  %call_ret = call fastcc { float, float, float, float } @feedbackStep(float %qDot_0, float %qDot_1, float %qDot_2, float %qDot_3, float %beta_load, float %s_0_1, float %s_1_1, float %s_2_1, float %s_3)
  %qDot_0_1 = extractvalue { float, float, float, float } %call_ret, 0
  %qDot_1_1 = extractvalue { float, float, float, float } %call_ret, 1
  %qDot_2_1 = extractvalue { float, float, float, float } %call_ret, 2
  %qDot_3_1 = extractvalue { float, float, float, float } %call_ret, 3
  br label %._crit_edge2

._crit_edge2:                                     ; preds = %._crit_edge, %2
  %qDot_3_10 = phi float [ %qDot_3, %2 ], [ %qDot_3_1, %._crit_edge ]
  %qDot_2_11 = phi float [ %qDot_2, %2 ], [ %qDot_2_1, %._crit_edge ]
  %qDot_1_12 = phi float [ %qDot_1, %2 ], [ %qDot_1_1, %._crit_edge ]
  %qDot = phi float [ %qDot_0, %2 ], [ %qDot_0_1, %._crit_edge ]
  call fastcc void @integrateQdot([4 x float]* @q, float %qDot, float %qDot_1_12, float %qDot_2_11, float %qDot_3_10)
...
; <label>:1                                       ; preds = %0
  ...
  %notlhs1 = icmp ne i8 %tmp_233, -1
  %notrhs1 = icmp eq i23 %tmp_234, 0
  %tmp_235 = or i1 %notrhs1, %notlhs1
...
; <label>:2                                       ; preds = %1
  ...
  %notlhs2 = icmp ne i8 %tmp_238, -1
  %notrhs2 = icmp eq i23 %tmp_239, 0
  %tmp_240 = or i1 %notrhs2, %notlhs2
...
._crit_edge:                                      ; preds = %2, %1, %0
  ...
  %qDot_3 = fmul float %tmp_83, 5.000000e-01
  ...
  %notlhs6 = icmp ne i8 %tmp_243, -1
  %notrhs7 = icmp eq i23 %tmp_244, 0
  %tmp_245 = or i1 %notrhs7, %notlhs6
...
; <label>:4                                       ; preds = %._crit_edge
  ...
  %notlhs8 = icmp ne i8 %tmp_248, -1
  %notrhs9 = icmp eq i23 %tmp_249, 0
  %tmp_250 = or i1 %notrhs9, %notlhs8
...
; <label>:5                                       ; preds = %4
  ...
  %notlhs3 = icmp ne i8 %tmp_253, -1
  %notrhs3 = icmp eq i23 %tmp_254, 0
  %tmp_255 = or i1 %notrhs3, %notlhs3
...
._crit_edge3:                                     ; preds = %5, %4, %._crit_edge
  ...
  %call_ret2 = call fastcc { float, float, float } @normalise.1(float %s_0, float %s_1, float %s_2, float %s_3) nounwind
  %s_2_2 = extractvalue { float, float, float } %call_ret2, 1
  %s_1_2 = extractvalue { float, float, float } %call_ret2, 0
  %s_0_2 = extractvalue { float, float, float } %call_ret2, 2
  %beta_load = load float* @beta, align 4
  %call_ret = call fastcc { float, float, float, float } @feedbackStep(float %qDot_0, float %qDot_1, float %qDot_2, float %qDot_3, float %beta_load, float %s_0_2, float %s_1_2, float %s_2_2, float %s_3) nounwind
  %qDot_0_2 = extractvalue { float, float, float, float } %call_ret, 0
  %qDot_1_2 = extractvalue { float, float, float, float } %call_ret, 1
  %qDot_2_2 = extractvalue { float, float, float, float } %call_ret, 2
  %qDot_3_2 = extractvalue { float, float, float, float } %call_ret, 3
  br label %._crit_edge5

._crit_edge5:                                     ; preds = %._crit_edge3, %5
  %qDot_3_13 = phi float [ %qDot_3, %5 ], [ %qDot_3_2, %._crit_edge3 ]
  %qDot_2_14 = phi float [ %qDot_2, %5 ], [ %qDot_2_2, %._crit_edge3 ]
  %qDot_1_15 = phi float [ %qDot_1, %5 ], [ %qDot_1_2, %._crit_edge3 ]
  %qDot = phi float [ %qDot_0, %5 ], [ %qDot_0_2, %._crit_edge3 ]
  call fastcc void @integrateQdot([4 x float]* @q, float %qDot, float %qDot_1_15, float %qDot_2_14, float %qDot_3_13) nounwind
